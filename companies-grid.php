...
<?php include 'layouts/head-main.php'; ?>
    ...
    <head>
        ...
        <title>Company - HRMS admin template</title>
                ...
                <div class="content container-fluid">
						...
						<div class="row align-items-center">
							...
							<div class="col-md-8 float-end ms-auto">
								<div class="d-flex title-head">
									...
									<a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_company"><i class="la la-plus-circle"></i> Add Companies</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="filter-section">
						<ul>
							<li>
								<div class="view-icons">
									<a href="companies.php" class="list-view btn btn-link"><i class="las la-list"></i></a>
									<a href="companies-grid.php" class="grid-view btn btn-link active"><i class="las la-th"></i></a>
								</div>
							</li>
							<li>
								<div class="form-sort">
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										<a href="company-details.php" class="company-icon">
											<img src="assets/img/icons/company-icon-01.svg" alt="Img">
										</a>
										<h5 class="name-user">
											<a href="company-details.php">NovaWaveLLC</a>
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											...
											<a class="dropdown-item" href="company-details.php"><i class="fa-regular fa-eye"></i> Preview</a>
								...
								<div class="grid-footer d-flex justify-content-between">
									...
									<div class="users-group">
										<ul>
											<li><a href="#"><img src="assets/img/avatar/avatar-19.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-20.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-21.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-22.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-23.jpg" alt="Img"></a></li>
						...
						<div class="col-xxl-3 col-xl-4 col-md-6">
							<div class="contact-grid">
								...
								<div class="grid-footer d-flex justify-content-between">
									...
									<div class="users-group">
										<ul>
											<li><a href="#"><img src="assets/img/avatar/avatar-24.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-25.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-26.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-27.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-28.jpg" alt="Img"></a></li>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="company-details.php">SilverHawk</a>
											<span class="set-star mt-1">
								...
								<div class="grid-footer d-flex justify-content-between">
									...
									<div class="users-group">
										<ul>
											<li><a href="#"><img src="assets/img/avatar/avatar-1.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-2.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-3.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-4.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-5.jpg" alt="Img"></a></li>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="company-details.php">SummitPeak</a>
											<span class="set-star mt-1">
								...
								<div class="grid-footer d-flex justify-content-between">
									...
									<div class="users-group">
										<ul>
											<li><a href="#"><img src="assets/img/avatar/avatar-6.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-7.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-8.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-9.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-10.jpg" alt="Img"></a></li>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="company-details.php">RiverStone V entur</a>
											<span class="set-star mt-1">
								...
								<div class="grid-footer d-flex justify-content-between">
									...
									<div class="users-group">
										<ul>
											...
											<li><a href="#"><img src="assets/img/avatar/avatar-22.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-19.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-18.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-17.jpg" alt="Img"></a></li>
											<li><a href="#" class="total-group-member">+10</a></li>
										</ul>
									</div>
								</div>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="company-details.php">Bright Bridge Grp</a>
											<span class="set-star mt-1">
								...
								<div class="grid-footer d-flex justify-content-between">
									...
									<div class="users-group">
										<ul>
											<li><a href="#"><img src="assets/img/avatar/avatar-11.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-12.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-13.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-14.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-15.jpg" alt="Img"></a></li>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="company-details.php">CoastalStar Co.</a>
											<span class="set-star mt-1">
								...
								<div class="grid-footer d-flex justify-content-between">
									...
									<div class="users-group">
										<ul>
											<li><a href="#"><img src="assets/img/avatar/avatar-16.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-17.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-18.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-19.jpg" alt="Img"></a></li>
											<li><a href="#"><img src="assets/img/avatar/avatar-20.jpg" alt="Img"></a></li>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="company-details.php">HarborView</a>
											<span class="set-star mt-1">
												<i class="fa fa-star filled me-2"></i>4.2
											</span>
										</h5>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="company-details.php">Golden Gate Ltd</a>
											<span class="set-star mt-1">
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="company-details.php">Redwood Inc</a>
											<span class="set-star mt-1">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center form-wizard-button">
								...
								<a href="companies-grid.php" class="btn btn-primary">Okay</a>
							</div>
						</div>
					</div>
				</div>
