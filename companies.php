                ...
                <div class="content container-fluid">
					...
					<div class="filter-section">
						<ul>
							<li>
								<div class="view-icons">
									<a href="companies.php" class="list-view btn btn-link active"><i class="las la-list"></i></a>
									<a href="companies-grid.php" class="grid-view btn btn-link"><i class="las la-th"></i></a>
								</div>
							</li>
							<li>
								<div class="form-sort">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center form-wizard-button">
								...
								<a href="companies.php" class="btn btn-primary">Okay</a>
							</div>
						</div>
					</div>
				</div>
