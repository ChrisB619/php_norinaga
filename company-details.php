						...
						<div class="col-md-12">
								...
								<div class="row align-items-center">
									<div class="col-sm-6">
										<ul class="contact-breadcrumb">
											<li><a href="companies.php"><i class="las la-arrow-left"></i> Companies</a></li>
											<li>NovaWave LLC</li>
										</ul>
									</div>
									<div class="col-sm-6 text-sm-end">
										<div class="contact-pagination">
											...
											<ul>
												<li>
													<a href="company-details.php"><i class="las la-arrow-left"></i></a>
												</li>
												<li>
													<a href="company-details.php"><i class="las la-arrow-right"></i></a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div class="contact-wrap">
								...
								<div class="contacts-action">
									...
									<a href="chat.php" class="btn-icon"><i class="feather-message-circle"></i></a>
													...
													<div class="row">
														...
														<div class="col-lg-6 col-md-6">
															<div class="input-block mb-3">
																...
																<input class="input-tags form-control" id="inputBox7" type="text" data-role="tagsinput"  name="Label" value="Promotion, Rated" >
															</div>
														</div>
														<div class="col-lg-6 col-md-6">
															<div class="input-block mb-3">
												...
												<div class="col-md-6">
													<div class="input-block mb-3">
														<div class="d-flex justify-content-between align-items-center">
															...
															<div class="status-toggle small-toggle-btn d-flex align-items-center">
																<span class="me-2 label-text">Option</span>
																<input type="checkbox" id="use2" class="check" checked="">
																<label for="use2" class="checktoggle"></label>
															</div>
														</div>
								...
								<fieldset>
									<form action="company-details.php">
										<div class="contact-input-set">
											...
											<div class="status-radio-btns d-flex mb-3">
												<div class="people-status-radio">
													<input type="radio" class="status-radio" id="test10" name="radio-group" checked>
													<label for="test10">Active</label>
												</div>
												<div class="people-status-radio">
													<input type="radio" class="status-radio" id="test8" name="radio-group">
						...
						<div class="modal-body">
							<div class="success-message text-center">
								...
								<div class="col-lg-12 text-center form-wizard-button">
									...
									<a href="company-details.php" class="btn btn-primary">Okay</a>
								</div>
							</div>
						</div>
					</div>
