								...
								<div class="row align-items-center">
									<div class="col-sm-6">
										<ul class="contact-breadcrumb">
											<li><a href="contact-grid.php"><i class="las la-arrow-left"></i> Contacts</a></li>
									...
									<div class="col-sm-6 text-sm-end">
										<div class="contact-pagination">
											...
											<ul>
												<li>
													<a href="contact-details.php"><i class="las la-arrow-left"></i></a>
												</li>
												<li>
													<a href="contact-details.php"><i class="las la-arrow-right"></i></a>
												</li>
											</ul>
										</div>
									</div>
						...
						<div class="modal-body">
							<div class="success-message text-center">
								...
								<div class="col-lg-12 text-center form-wizard-button">
									...
									<a href="contact-details.php" class="btn btn-primary">Okay</a>
								</div>
							</div>
						</div>
					</div>
