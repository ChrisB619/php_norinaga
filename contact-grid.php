                ...
                <div class="content container-fluid">
					...
					<div class="filter-section">
						<ul>
							<li>
								<div class="view-icons">
									<a href="contact-list.php" class="list-view btn btn-link"><i class="las la-list"></i></a>
									<a href="contact-grid.php" class="grid-view btn btn-link active"><i class="las la-th"></i></a>
								</div>
							</li>
							<li>
								<div class="form-sort">
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										<a href="contact-details.php" class="avatar">
											<img src="assets/img/avatar/avatar-19.jpg" alt="Img">
										</a>
										<h5 class="name-user">
											<a href="contact-details.php">Darlee Robertson</a>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="contact-details.php">Vaughan</a>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="contact-details.php">Jessica</a>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="contact-details.php">Dawn Mercha</a>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="contact-details.php">Rachel Hampton</a>
							...
							<div class="contact-grid">
								<div class="grid-head">
									<div class="users-profile">
										...
										<h5 class="name-user">
											<a href="contact-details.php">Jonelle Curtiss</a>
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center form-wizard-button">
								...
								<a href="contact-grid.php" class="btn btn-primary">Okay</a>
							</div>
						</div>
					</div>
				</div>
