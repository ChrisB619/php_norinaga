								...
								<div class="row align-items-center">
									<div class="col-sm-6">
										<ul class="contact-breadcrumb">
											<li><a href="deals.php"><i class="las la-arrow-left"></i> Deals</a></li>
									...
									<div class="col-sm-6 text-sm-end">
										<div class="contact-pagination">
											...
											<ul>
												<li>
													<a href="deals-details.php"><i class="las la-arrow-left"></i></a>
												</li>
												<li>
													<a href="deals-details.php"><i class="las la-arrow-right"></i></a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div class="card contact-sidebar">
								...
								<ul class="other-info">
									...
									<li>
										...
										<span><img src="assets/img/avatar/avatar-19.jpg" class="avatar-xs rounded-circle" alt="img"> Darlee Robertson</span>
									</li>
								</ul>						
							</div>
						</div>
										...
										<div class="contact-input-set">
											...
											<div class="status-radio-btns d-flex mb-3">
												<div class="people-status-radio">
													<input type="radio" class="status-radio" id="testact" name="radio-group" checked>
						...
						<div class="modal-body">
							<div class="success-message text-center">
								...
								<div class="col-lg-12 text-center form-wizard-button">
									...
									<a href="deals-details.php" class="btn btn-primary">Okay</a>
								</div>
							</div>
						</div>
					</div>
