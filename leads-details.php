                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <ul class="contact-breadcrumb">
                                        <li><a href="leads.php"><i class="las la-arrow-left"></i> Leads</a></li>
                                ...
                                <div class="col-sm-6 text-sm-end">
                                    <div class="contact-pagination">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="leads-details.php"><i class="las la-arrow-left"></i></a>
                                            </li>
                                            <li>
                                                <a href="leads-details.php"><i class="las la-arrow-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
