                                                    ...
                                                    <div class="text-center mt-2 mb-4">
                                                        <div class="auth-logo">
                                                            <a href="index.php" class="logo logo-dark">
                                                                <span class="logo-lg">
                                                                    <img src="assets/img/logo2.png" alt="Logo" height="42">
                                                                </span>
                                                            </a>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body card-buttons">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#example-modal-xl">
                                        Extra Large Modal
                                    </button>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#example-modal-lg">
                                        Large Modal
                                    </button>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#example-modal-sm">
                                        Small Modal
                                    </button>

                                     <!--  Modal -->
                                    <div class="modal fade" id="example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal fade" id="example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-header">
